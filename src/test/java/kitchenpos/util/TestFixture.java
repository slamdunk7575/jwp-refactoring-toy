...
public class TestFixture {
    ...
    // MenuProduct
    public static final MenuProduct 메뉴상품_후라이드 = new MenuProduct(상품_후라이드, Quantity.of(1));
    public static final MenuProduct 메뉴상품_양념 = new MenuProduct(상품_양념, Quantity.of(1));
}
