...
public class TableAcceptanceTest extends AcceptanceTest {
    ...
    void manageOrderTable() {
        ...
        // when
        ExtractableResponse<Response> findResponse = 주문_테이블_목록_조회_요청(orderTable);
        ...
        ExtractableResponse<Response> guestResponse = 주문_테이블_손님수_변경_요청(createResponse, orderTable);
    ...
    public static ExtractableResponse<Response> 주문_테이블_목록_조회_요청(OrderTable orderTable) {
    ...
    public static ExtractableResponse<Response> 주문_테이블_손님수_변경_요청(ExtractableResponse<Response> createResponse, OrderTable orderTable) {
        String location = createResponse.header("Location");
        return RestAssured
                .given().log().all()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
